...
import org.techtown.gituserinfo.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RetrofitBuilder.api.getUserInfo(userid = User.id)
            .enqueue(object : Callback<UserInfo> {
                ...
                override fun onResponse(call: Call<UserInfo>, response: Response<UserInfo>) {
                    ...
                    Log.d(
                        TAG,
                        "onResponse: 유저아이디: ${userinfo?.login}, 팔로워: ${userinfo?.followers}, 팔로잉: ${userinfo?.following} "
                    )
                }
